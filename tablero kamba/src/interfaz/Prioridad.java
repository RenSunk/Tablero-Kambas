...
public class Prioridad extends JFrame implements ActionListener{
	...
	public Prioridad(Proyecto miProyecto, Principal miPrincipal,String nombre) {
		this.nombre = nombre;
	...
	public void actionPerformed(ActionEvent e) {
		if(cambiar == e.getSource()) {
			...
			if(!miProyecto.cambiar_prioridad(nombre, prioridad)) {
